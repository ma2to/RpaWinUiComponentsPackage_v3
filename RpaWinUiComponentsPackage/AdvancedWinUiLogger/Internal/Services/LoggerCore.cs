...
public class LoggerCore : ILoggerCore
{
    ...
    public async Task<Result<RotationResult>> RotateLogsAsync()
    {
        ...
        try
        {
            ...
            var result = new RotationResult(filesRotated, newLogFile, archiveFile);
    ...
    public async Task<Result<CleanupResult>> CleanupOldLogsAsync(int maxAgeInDays = 30)
    {
        ...
        try
        {
            ...
            var result = new CleanupResult(filesDeleted, bytesFreed, deletedFiles);
    ...
    public async Task<Result<IReadOnlyList<LogFileInfo>>> GetLogFilesAsync()
    {
        ...
        try
        {
            ...
            var sortedFiles = fileInfos.OrderByDescending(f => f.LastModified).ToList().AsReadOnly();
