...
/// </summary>
internal class FileLoggerService : ILogger
{
    private readonly Core.Models.LoggerConfiguration _config;
    ...
    public FileLoggerService(Core.Models.LoggerConfiguration config, ILogger? externalLogger = null)
    {
