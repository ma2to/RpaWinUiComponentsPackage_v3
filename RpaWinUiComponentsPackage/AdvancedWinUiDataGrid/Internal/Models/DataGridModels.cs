...
namespace RpaWinUiComponentsPackage.AdvancedWinUiDataGrid.Internal.Models;
...
/// <summary>
/// Validation result for single field or entire dataset
/// </summary>
...
/// <summary>
/// Search result for basic search operations
/// </summary>
...
/// <summary>
/// Search options for search operations
/// </summary>
...
/// <summary>
/// Basic filter criteria for single column
/// </summary>
...
/// <summary>
/// Filter result for filter operations
/// </summary>
public class FilterResult
{
    public int VisibleRows { get; set; }
    public int HiddenRows { get; set; }
    public int TotalRows => VisibleRows + HiddenRows;
    public TimeSpan Duration { get; set; }
    public bool WasCancelled { get; set; }
}
...
/// <summary>
/// Basic sort options for single column
/// </summary>
...
/// <summary>
/// Sort result for sort operations
/// </summary>
public class SortResult
{
    public string ColumnName { get; set; } = string.Empty;
    public bool IsAscending { get; set; }
    public int SortedRows { get; set; }
    public TimeSpan Duration { get; set; }
    public bool WasCancelled { get; set; }
}
...
public class DataGridCell
{
    ...
    public bool IsValidationCell { get; set; } = false;
    public bool IsDeleteCell { get; set; } = false;
    public bool IsSpecialCell => IsValidationCell || IsDeleteCell;
...
#region Type Aliases for Compatibility

/// <summary>
/// Alias for CoreColumnConfiguration to maintain compatibility
/// </summary>
public class GridColumnDefinition : CoreColumnConfiguration
{
    public GridColumnDefinition() : base() { }
    
    public GridColumnDefinition(string name, Type dataType)
    {
        Name = name;
        DisplayName = name;
        Type = dataType;
...
/// <summary>
/// Alias for ColumnDefinition compatibility
/// </summary>
public class ColumnDefinition : CoreColumnConfiguration
{
    public ColumnDefinition() : base() { }
}

/// <summary>
/// DataGrid configuration for initialization
/// </summary>
public class DataGridConfiguration
{
    public CoreColorConfiguration? ColorConfig { get; set; }
    public CoreValidationConfiguration? ValidationConfig { get; set; }
