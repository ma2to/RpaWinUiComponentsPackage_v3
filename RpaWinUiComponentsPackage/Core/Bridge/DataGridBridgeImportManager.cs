...
internal sealed class DataGridBridgeImportManager : IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (data == null || !data.Any())
            {
                ...
                return new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { "No data provided" } };
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (Exception ex)
        {
            ...
            return new ImportResult { Success = false, ErrorRows = dataTable?.Rows?.Count ?? 0, Errors = new[] { ex.Message } };
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult(new ImportResult { Success = true, ImportedRows = 0 });
    }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (string.IsNullOrWhiteSpace(csvContent))
            {
                ...
                return new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { "Empty CSV content" } };
            }
        ...
        catch (Exception ex)
        {
            ...
            return new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { ex.Message } };
        }
    }
        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (string.IsNullOrWhiteSpace(jsonContent))
            {
                ...
                return new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { "Empty JSON content" } };
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                return Task.FromResult(new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { "Empty XML content" } });
            }
        ...
        catch (Exception ex)
        {
            ...
            return Task.FromResult(new ImportResult { Success = false, ErrorRows = 0, Errors = new[] { ex.Message } });
        }
    }
